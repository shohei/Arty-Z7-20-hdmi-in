...
set repo_dir2 "/home/shohei/Downloads/vivado-library" 
...
set_property "ip_repo_paths" "[list [file normalize $repo_dir] [file normalize $repo_dir2]]" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part $part -flow {Vivado Synthesis 2017} -strategy "Flow_RuntimeOptimized" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part $part -flow {Vivado Implementation 2017} -strategy "Flow_RuntimeOptimized" -constrset constrs_1 -parent_run synth_1
} else {
